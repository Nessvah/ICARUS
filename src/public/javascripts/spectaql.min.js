...
function scrollSpy() {
  ...
  var n = debounce(function () {
    ...
    o = debounce(function () {
      ...
      r !== i &&
        ...
        (t = s((r = r ? document.querySelector('#nav a[href="#' + r.id + '"]') : null))),
        (n = (o = s(e)) !== t),
        o && n && u(o, !1),
        t && n && u(t, !0),
        r &&
  ...
  function u(e, t) {
    for (var n = t ? 'add' : 'remove'; e; ) e.classList[n]('nav-scroll-expand'), (e = s(e.parentNode));
  }
  function s(e) {
    return e && e.closest ? e.closest('.nav-group-section') : null;
  }
  setTimeout(function () {
    t(), o(), window.addEventListener('scroll', o), window.addEventListener('resize', n);
  }, 300);
}
function toggleMenu() {
  var t = 'drawer-open',
  ...
  e.addEventListener('click', r), n.addEventListener('click', r), o.addEventListener('click', r);
}
